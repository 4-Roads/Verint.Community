...
using FourRoads.VerintCommunity.PwaFeatures.DataProvider;
using FourRoads.VerintCommunity.PwaFeatures.Extensions;
using FourRoads.VerintCommunity.PwaFeatures.Resources;
...
namespace FourRoads.VerintCommunity.PwaFeatures.Plugins
{
    public class PwaFeaturesPlugin : IConfigurablePlugin, INotificationDistributionType, ITranslatablePlugin,  IPluginGroup, INavigable, IHtmlHeaderExtension , IScriptedContentFragmentExtension, IScriptablePlugin, IRequiredConfigurationPlugin
    {
        ...
        public bool Distribute(Notification notification, NotificationUserChanges userChanges)
        {
            ...
            {
                Apis.Get<IExceptions>().Log(new Exception("Push Notification General Error", ex));
            }
            ...
            // Subscribe the devices corresponding to the registration tokens to the
                ...
                var response = Task.Run(
                    () =>
                    {
                        ...
                        {
                           Apis.Get<IExceptions>().Log(new Exception("Google Push Notification Failed" ,ex));
                        }
