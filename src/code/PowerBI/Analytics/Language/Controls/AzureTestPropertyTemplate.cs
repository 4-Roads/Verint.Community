...
namespace FourRoads.VerintCommunity.PowerBI.Analytics.Language.Controls
{
    public class AzureTestPropertyTemplate : IPropertyTemplate, INamingContainer
    {
        public string[] DataTypes => new string[] { "custom", "string" };

        public string TemplateName => "powerBI_azureTest";
        ...
        public string Name => "Azure Test Property Template";
