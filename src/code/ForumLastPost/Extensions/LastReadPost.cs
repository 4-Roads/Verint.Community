...
using FourRoads.VerintCommunity.ForumLastPost.DataProvider;
using FourRoads.VerintCommunity.ForumLastPost.Interfaces;
using FourRoads.VerintCommunity.ForumLastPost.Logic;
using FourRoads.VerintCommunity.ForumLastPost.ScriptedFragmentss;
...
namespace FourRoads.VerintCommunity.ForumLastPost.Extensions
{
    public class LastReadForumSqlInstaller : Installer.SqlScriptsInstaller
    {
        ...
        {
            get { return "FourRoads.VerintCommunity.ForumLastPost.Resources."; }
        }
