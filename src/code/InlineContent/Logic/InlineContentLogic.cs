...
using FourRoads.VerintCommunity.InlineContent.Security;
...
namespace FourRoads.Common.VerintCommunity.Components.Logic
{
    public class InlineContentLogic
    {
        ...
        public InlineContentData GetInlineContent(string contentName)
        {
            ...
            CacheService.TryGet(cacheKey, CacheScope.All, out InlineContentData result);
            ...
            if (result == null && InlineContentStore != null)
            {
                ...
                if (file != null)
                {
                    using (Stream stream = file.OpenReadStream())
                    {
                        ...
                        CacheService.Put(cacheKey, CacheScope.All, result, new PutOptions());
                    }
                }
            }
            return result;
