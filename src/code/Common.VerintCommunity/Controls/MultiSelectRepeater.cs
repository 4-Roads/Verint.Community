...
[assembly: WebResource("FourRoads.Common.VerintCommunity.Controls.MultiSelectRepeater.js", "text/javascript", PerformSubstitution = true)]
namespace FourRoads.Common.VerintCommunity.Controls
{
    public class MultiSelectRepeater : WrappedRepeater, INamingContainer
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            CSControlUtility.Instance().RegisterClientScriptResource(this, typeof(MultiSelectRepeater), "FourRoads.Common.VerintCommunity.Controls.MultiSelectRepeater.js");
